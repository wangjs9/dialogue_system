...
class RLHFArguments:
    ...
    simulator_model: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the simulator model used for the RL training."},
    )
    simulator_model_adapters: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the adapters of the simulator model."},
    )
    simulator_model_quantization_bit: Optional[int] = field(
        default=None,
        metadata={"help": "The number of bits to quantize the simulator model."},
    )
    simulator_model_type: Literal["lora", "full", "api"] = field(
        default="lora",
        metadata={"help": "The type of the simulator model in RL training. Lora model only supports lora training."},
    )
